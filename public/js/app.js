...
(function () {
  ...
  function initTranslation() {
    // i18n désactivé — fichiers server/i18n absents, non utilisé dans CAERT
    return;
...
(function () {
  ...
  function initSidebar() {
    ...
    if (sidebarCollapse.length && typeof sidebarCollapse.collapse === 'function') {
    ...
    if (!useAsideHover()) {
      ...
      var $collapse = currentItem.children('.collapse');
      if ($collapse.length && typeof $collapse.collapse === 'function') {
