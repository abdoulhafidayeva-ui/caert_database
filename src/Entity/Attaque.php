...
class Attaque
{
    ...
    #[ORM\ManyToOne(targetEntity: User::class, inversedBy: 'attaques')]
    private $user;

    #[ORM\OneToMany(targetEntity: AllData::class, mappedBy: 'attaque')]
    private $allData;
    ...
    public function removeAllData(AllData $allData): self
    {
        if ($this->allData->removeElement($allData)) {
            ...
            if ($allData->getAttaque() === $this) {
                $allData->setAttaque(null);
            }
        }
