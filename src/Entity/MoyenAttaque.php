...
#[ORM\Entity(repositoryClass: MoyenAttaqueRepository::class)]
class MoyenAttaque
{
    #[ORM\Id]
    #[ORM\GeneratedValue]
    ...
    #[ORM\ManyToOne(targetEntity: User::class, inversedBy: 'moyenAttaques')]
    private $user;

    #[ORM\OneToMany(targetEntity: AllData::class, mappedBy: 'moyenAttaque')]
    private $allData;
    ...
    public function removeAllData(AllData $allData): self
    {
        if ($this->allData->removeElement($allData)) {
            ...
            if ($allData->getMoyenAttaque() === $this) {
                $allData->setMoyenAttaque(null);
            }
        }
