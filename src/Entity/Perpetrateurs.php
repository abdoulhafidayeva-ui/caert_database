...
#[ORM\Entity(repositoryClass: PerpetrateursRepository::class)]
class Perpetrateurs
{
    #[ORM\Id]
    #[ORM\GeneratedValue]
    ...
    #[ORM\ManyToOne(targetEntity: User::class, inversedBy: 'perpetrateurs')]
    private $user;

    #[ORM\OneToMany(targetEntity: AllData::class, mappedBy: 'perpetrateur')]
    private $allData;
    ...
    public function removeAllData(AllData $allData): self
    {
        if ($this->allData->removeElement($allData)) {
            ...
            if ($allData->getPerpetrateur() === $this) {
                $allData->setPerpetrateur(null);
            }
        }
