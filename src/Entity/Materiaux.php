...
class Materiaux
{
    ...
    #[ORM\ManyToOne(targetEntity: User::class, inversedBy: 'materiauxes')]
    private $user;

    #[ORM\OneToMany(targetEntity: AllData::class, mappedBy: 'materieaux')]
    private $allData;
    ...
    public function removeAllData(AllData $allData): self
    {
        if ($this->allData->removeElement($allData)) {
            ...
            if ($allData->getMaterieaux() === $this) {
                $allData->setMaterieaux(null);
            }
        }
